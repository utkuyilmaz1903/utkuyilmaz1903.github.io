...
@@article-header
*GSoC 2026 · MethodOfLines.jl · Final DevLog*
...
## Scenario A — The Stationary Viscous Shock
...
@@code-caption
*Listing 1 — Non-uniform WENO discretization via a density-clustered grid*
@@
...
## Scenario B — Interfacial Front Compression
...
- **Seam continuity** — Machine precision. The interface identification is algebraic, so $|c_1 - c_2|$ at the seam is zero to floating-point tolerance.
...
@@cta-box
**Full implementation.** The mathematical infrastructure, implementation details, and quantitative showcase are collected in [PR #616](https://github.com/SciML/MethodOfLines.jl/pull/616).
@@
